...
#for i in tqdm.tqdm(range(60)):
    img = scale_to_width(cv2.imread('./frames/'+str(i)+'.jpg'),96)
    gray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)
    colorset = "鬱鑑驚襲籠艦顧議競護願鏡顔講謝績厳縮優親頭館線横談歌園語遠雲森強教夏校草音雨体学花気貝糸左右玉月四王円女火下山口三十乙丁人ニ　　"
    output = ""
    for gray2 in gray:
        for dark in gray2:
